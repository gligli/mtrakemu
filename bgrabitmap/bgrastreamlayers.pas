...
function LoadLayersFromStream(AStream: TStream; out ASelectedLayerIndex: integer) : TBGRALayeredBitmap;
...
begin
  ...
  try
    ...
    begin
      ...
      if (LayerHeaderSize < 28) then
        raise exception.Create('Invalid layer header size');
      ...
      result.LayerUniqueId[LayerIndex] := WinReadLongint(AStream);
